            ...
            <div>                 
               <div class="burgermenu" @click="show = !show">                  
                  <a href="#" type="button" class="burgermenu__burger" v-if="!show">
                     <img class="burgermenu__image" src="../assets/images/icons/openmenu.svg" alt="">                         
                  </a> 
                  <a href="#" type="button" class="burgermenu__burger" v-else>
                     <img class="burgermenu__image" src="../assets/images/icons/closemenu.svg" alt="">                                   
                  </a>                                     
               </div>
               <transition name="burger">
                  <ul class="burgermenu__list" v-if="show">                        
                     <li class="burgermenu__item" v-for="item in data" :key="item" @click="show = false">
                        <router-link  href="" :to="item.path" >{{item.name}}</router-link>              
                     </li>                             
                  </ul>   
               </transition>
